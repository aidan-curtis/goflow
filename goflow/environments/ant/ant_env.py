...
for dr_method in ["NoDR", "FullDR", "LSDR", "ADR", "GOFLOW", "DORAEMON"]:
    gym.register(
        id=f"Ant-{dr_method}-v0",
        entry_point="goflow.environments.ant.ant_env:AntEnv",
